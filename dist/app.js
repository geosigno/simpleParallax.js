!(function(e, t) {
    ...
    return (function(e) {
        ...
        function E(e) {
            ...
            return (
                ...
                (function(e) {
                    ...
                    return (h = {}), x(0), 'prepare' === u && 0 === v && 0 === y && k(), t;
                })
            );
        }
        function x(e) {
        ...
        function j(t) {
            ...
            var M,
                A = [];
            for (i = 0; i < v.length; i++) (c = v[i]), _[c] && _[c].hot._selfAccepted && A.push({ module: c, errorHandler: _[c].hot._selfAccepted });
            f('dispose'),
            ...
            for (var T, F, C = v.slice(); 0 < C.length; )
                if (((c = C.pop()), (l = _[c]))) {
                    ...
                    for (a[c] = I, l.hot.active = !1, delete _[c], delete y[c], o = 0; o < l.children.length; o++) {
                        ...
                        S && 0 <= (M = S.parents.indexOf(c)) && S.parents.splice(M, 1);
                    }
                }
            for (c in y) if (Object.prototype.hasOwnProperty.call(y, c) && (l = _[c])) for (F = y[c], o = 0; o < F.length; o++) (T = F[o]), 0 <= (M = l.children.indexOf(T)) && l.children.splice(M, 1);
                ...
                if (Object.prototype.hasOwnProperty.call(y, c) && (l = _[c])) {
                    ...
                    for (i = 0; i < q.length; i++) {
                        ...
                        try {
                            ...
                            t.onErrored && t.onErrored({ type: 'accept-errored', moduleId: c, dependencyId: F[i], error: n }), t.ignoreErrored || R || (R = n);
                        }
                    }
                }
                ...
                try {
                    ...
                    if ('function' == typeof z.errorHandler)
                        try {
                            ...
                            t.onErrored && t.onErrored({ type: 'self-accept-error-handler-errored', moduleId: c, error: n, originalError: i }), t.ignoreErrored || R || (R = n), R || (R = i);
                        }
                    else t.onErrored && t.onErrored({ type: 'self-accept-errored', moduleId: c, error: i }), t.ignoreErrored || R || (R = i);
                }
            }
            return R
