...
(function (root, factory) {
    ...
    var SimpleParallax = function () {
        function SimpleParallax(element, options) {
            _classCallCheck(this, SimpleParallax);
        ...
        _createClass(SimpleParallax, [{
            ...
            value: function unWrapElement() {
                ...
                var parent = this.elementContainer.parentNode;
            ...
            value: function getElementOffset() {
                ...
                var pos = this.elementContainer.getBoundingClientRect();
            ...
            value: function getViewportOffsetTop() {
            ...
            value: function getViewportOffsetHeight() {
            ...
            value: function getViewportOffsetBottom() {
            ...
            value: function getTranslateValue() {
                ...
                var percentage = ((this.viewportBottom - this.elementTopX) / ((this.viewportHeight + this.elementHeight) / 100)).toFixed(1);
